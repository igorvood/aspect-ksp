...
internal class ColumnEntityMapGeneratorTest : AbstractGeneratorTest("DataModel.json") {
    ...
    @BeforeAll
    fun beforeAllT() {
        val columnEntityDataSingleFileGenerator = ColumnEntityMapGenerator(PackageName("test"), metaInformation)
    ...
    @ParameterizedTest
    @MethodSource("ru.vood.processor.datamodel.generator.meta.ColumnEntityMapGeneratorTest#testCaseData")
    @Disabled
    ...
    companion object {
        private val testData = listOf(TestCase("FullColumnNameEnum"))
